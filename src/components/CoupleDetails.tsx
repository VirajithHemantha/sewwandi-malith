      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8 relative z-10">
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-end">
            ...
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Son of Mr. M.G.Kusumsiri<br />& Mrs. Jayamini Palika</p>
          </div>
        ...
        >
          <div className="mb-4 flex flex-col items-center lg:items-start">
            ...
            <p className="text-stone-500/90 font-serif italic text-base sm:text-lg">Daughter of Mr. Ajith Niranjan<br />& Mrs. Rasika Lasanthi</p>
          </div>
